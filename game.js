...
const weapons = [
  ...
  { name: "短剑", cost: 16, damage: 16, range: 64, cooldown: 20, kind: "melee" },
  { name: "长剑", cost: 36, damage: 20, range: 92, cooldown: 30, kind: "melee" },
  { name: "普通弓", cost: 31, damage: 24, range: 560, cooldown: 30, kind: "bow" },
  { name: "火焰弓", cost: 160, damage: 30, range: 600, cooldown: 34, kind: "fireBow" },
  { name: "闪电弓", cost: 175, damage: 34, range: 620, cooldown: 24, kind: "lightningBow" },
  { name: "冷却弓", cost: 170, damage: 28, range: 590, cooldown: 32, kind: "frostBow" },
  { name: "缓慢弓", cost: 165, damage: 26, range: 590, cooldown: 32, kind: "slowBow" },
  { name: "闪电剑", cost: 150, damage: 42, range: 98, cooldown: 22, kind: "lightningSword" },
  { name: "火焰剑", cost: 180, damage: 46, range: 100, cooldown: 26, kind: "fireSword" },
];

const shopGoods = [
  { type: "weapon", index: 1, name: "短剑", cost: 16 },
  { type: "weapon", index: 2, name: "长剑", cost: 36 },
  { type: "weapon", index: 3, name: "普通弓", cost: 31 },
  { type: "horse", name: "马", cost: 66 },
  { type: "skin", item: "diverSkin", name: "潜水员皮肤", cost: 66 },
  { type: "weapon", index: 4, name: "火焰弓", cost: 160 },
  { type: "weapon", index: 5, name: "闪电弓", cost: 175 },
  { type: "weapon", index: 6, name: "冷却弓", cost: 170 },
  ...
  { type: "item", item: "powerPotion", name: "力量药水", cost: 51 },
